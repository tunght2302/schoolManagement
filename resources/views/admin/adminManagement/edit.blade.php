                                ...
                                <form action="{{ route('admin.adminManagement.update', $oneUser->id) }}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name" class="form-control" id="fullnameInput"
                                            value="{{ old('name', $oneUser->name) }}" placeholder="Nhập họ tên">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input type="password" class="form-control pe-5 password-input" name="password"
                                                value="{{ old('password', $oneUser->password) }}"
                                    ...
                                    <div class="col-12">
                                        <div class="text-end">
                                            <a href="{{route('admin.adminManagement.index')}}" class="btn btn-success">Quay lại</a>
